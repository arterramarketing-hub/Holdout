...
- Desktop: WASD move, mouse aims (click to capture it), left mouse fires, right mouse aims down sights, R reloads,
  1/2/3 killstreaks, M mutes, O settings.
- Phone (landscape): left thumb moves, right thumb looks; fire, ADS and reload buttons on the right.
