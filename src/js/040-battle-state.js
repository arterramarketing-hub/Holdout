...
function buildSoldier(i) {
  ...
  return {
    ...
    fireCd: rand(0, 0.4) * (i ? 1 : 0), regenCd: 0,   // the squad's first shots are staggered; your own trigger is live the moment you deploy (the roll stays, so a seed replays the same front) invuln: 0, aim: -Math.PI / 2, r: 13,
