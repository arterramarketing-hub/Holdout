...
const QUALITY = {
  low:    { lines: 270, dpr: 1,   particles: 220, brass: 40,  corpses: 50,  rain: 0.35, glow: false, ragdolls: 3, debris: 30 },
  medium: { lines: 360, dpr: 1.5, particles: 500, brass: 100, corpses: 90,  rain: 0.7,  glow: true,  ragdolls: 5, debris: 60 },
  high:   { lines: 480, dpr: 2,   particles: 900, brass: 160, corpses: 120, rain: 1,    glow: true,  ragdolls: 8, debris: 90 },   // the N64 hi-res mode: the game's own look
  saver:  { lines: 240, dpr: 1,   particles: 160, brass: 24,  corpses: 40,  rain: 0.25, glow: false, ragdolls: 2, debris: 14 },  // the battery saver's: never chosen by Auto
};
