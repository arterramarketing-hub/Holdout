...
// and other soldiers' muzzle blooms (your own flash always blooms). Auto starts at Medium on a phone and High on a
// desktop, drops a step after 3 s of frames averaging over 24 ms, and climbs back after 10 s under 17.5 ms — never above
// where it started, and not within 30 s of a drop.
const QUALITY = {
